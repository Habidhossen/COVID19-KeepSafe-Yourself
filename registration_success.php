...
<body>
    ...
    <div class="registration-success-bg">
        <lottie-player src=" https://assets9.lottiefiles.com/packages/lf20_atippmse.json" background="transparent" speed="1" style="width: 150px; height: 150px;" loop autoplay>
        </lottie-player>
        <h3>Success</h3>
        <p>Congratulations, your account has been successfully created.
            <br>You may login now.
        </p>
        <a href="login.php" class="btn register-btn">Continue</a>
    </div>
    <!-- registration success starts here -->
