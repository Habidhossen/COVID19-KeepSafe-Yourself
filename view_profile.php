    ...
    <div class="container col-lg-6 col-md-8 col-sm-8 custom-profile-card">
        ...
        <form>
            ...
            <div class="form-group row align-items-center mt-2">
                ...
                <div class="col-8">
                    <input name="name" disabled class="form-control alert-success" value="<?php echo $usermobile; ?>">
                </div>
            </div>
            ...
            <div class="form-group row align-items-center mt-2">
                ...
                <div class="col-8">
                    <input name="name" disabled class="form-control alert-success" value="<?php echo $useraddress; ?>">
                </div>
            </div>
        </form>
