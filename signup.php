          ...
          <div class="col">
            <div class="register-left-part p-3">
              ...
              <p>
                ...
                dolorum laudantium eos harum iste pariatur beatae? Non saepe.
              </p>
              ...
              <form>
                ...
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 mb-3">
                  <div class="col">
                    ...
                    <input type="email" class="form-control form-control" id="" />
                  </div>
                  <div class="col">
                    <label for="" class="form-label">Password</label>
                    <input type="password" class="form-control form-control" id="" />
                  </div>
                </div>
                <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-2 mb-3">
                  <div class="col">
